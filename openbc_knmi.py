...
RD_Y0 = 445930  # - 6400.0  # 439710 m — southwest corner y
...
ITOT, JTOT = 64, 64
DX, DY = 2.0, 2.0  # grid spacing in meters
XSIZE = ITOT * DX
YSIZE = JTOT * DY

# Vertical levels
KMAX = 80
DZ0 = 2  # lowest level spacing (stretched grid)
...
THLS = 290.0  # surface liquid pot. temperature (K)
...
if __name__ == "__main__":
    ...
    # --- Surface ------------------------------------------------------------
    sim += ConstantSurfaceTemperatureModule(thls=THLS, z0mav=0.01, z0hav=0.01, ps=PS)
